...
export default function Contact() {
  ...
  return (
    <div className='max-w-[1240px] m-auto p-4 min-h-screen relative'>
      ...
      <form className='max-w-[600px] m-auto' onSubmit={handleSubmit(onSubmit)}>
        ...
        <button id='submit-btn' className='border shadow-lg p-3 w-full mt-2 mb-6 sm:mb-0' type='submit'>{buttonText}</button>
      </form>
